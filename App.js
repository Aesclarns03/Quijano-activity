...
const Picture = () => {
  return(
    <View>
       <Image source={{ uri: 'https://movefla.com/wp-content/uploads/2019/11/2-people-sitting-with-view-of-yellow-flowers-during-daytime-196666-1024x683.jpg'}} style ={styles.Picture} />
     </View>
  ) 
};
const BioData = () =>{
  return(
    <View> 
<Text style ={styles.name}> Clarence Jhon Quijano </Text>
...
const SubjectOfferings = ()=>{
  ...
  <View style = {styles.subjectOfferings}>
        <View>
          <Text style = {styles.subjectCode}>Research</Text>
          </View>
          <View>
          <Text style = {styles.subjectDescription}>Research Method</Text>
    ...
    <View style = {styles.subjectOfferings}>
        <View>
          <Text style = {styles.subjectCode}>PRO ELEC 1</Text>
          </View>
          <View>
          <Text style = {styles.subjectDescription}>Logic Design and Digital Computer</Text>
          <Text style = {styles.subjectUnits}> Units: 3</Text>
        </View>
        </View>
